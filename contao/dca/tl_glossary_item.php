...
if (in_array('ContaoGlossaryBundle', array_keys(System::getContainer()->getParameter('kernel.bundles')), true)) {
    ...
    PaletteManipulator::create()
        ...
        ->applyToPalette('default', 'tl_glossary_item');

    $GLOBALS['TL_DCA']['tl_glossary_item']['palettes']['__selector__'][] = 'canonicalType';
    $GLOBALS['TL_DCA']['tl_glossary_item']['subpalettes']['canonicalType_'.DcaHelper::RELCANONICAL_INTERNAL] = 'canonicalJumpTo';
    $GLOBALS['TL_DCA']['tl_glossary_item']['subpalettes']['canonicalType_'.DcaHelper::RELCANONICAL_EXTERNAL] = 'canonicalWebsite';
    ...
    $GLOBALS['TL_DCA']['tl_glossary_item']['fields']['canonicalJumpTo'] = [
        'exclude' => true,
        'inputType' => 'pageTree',
    ...
    $GLOBALS['TL_DCA']['tl_glossary_item']['fields']['canonicalWebsite'] = [
